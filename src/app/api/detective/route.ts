...
// const BASE_URL = 'https://cmikn86kp2ebl9nx1dv8s0zsi.agent.a.smyth.ai';
...
//                 error_message: parsed.error_message,
//                 code_snippet: parsed.code_snippet,
//                 root_cause: typeof rootCause === 'string' ? rootCause : JSON.stringify(rootCause),
//                 stackoverflow_research: typeof soResearch === 'string' ? soResearch : JSON.stringify(soResearch),
//                 docs_research: typeof docsResearch === 'string' ? docsResearch : JSON.stringify(docsResearch)
//             }),
//         });
...
//         const preventionRes = await fetch(`${BASE_URL}/api/provide_prevention_tips`, {
//             method: 'POST',
//             headers: { 'Content-Type': 'application/json' },
//             body: JSON.stringify({
//                 language: parsed.language,
...
//             output: `${typeof solution === 'string' ? solution : JSON.stringify(solution, null, 2)}\n\n${typeof prevention === 'string' ? prevention : JSON.stringify(prevention, null, 2)}`,
    ...
    try {
        ...
        const [soRes, docsRes] = await Promise.all([
            fetch(`${BASE_URL}/api/search_stackoverflow`, {
                ...
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    search_queries: parsed.search_queries || [parsed.error_message || input],
                    error_message: parsed.error_message || input,
                }),
            }),
            fetch(`${BASE_URL}/api/search_documentation`, {
